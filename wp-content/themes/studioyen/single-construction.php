...
<?php get_header('anchor'); ?>
				<div class="js-section auto-height">
					<div class="product__moneyshot" style="background-image: url(<?php the_field('img_01'); ?>)";>
						<div class="center-container text-white">
							<div class="v-center col-md-6">
				...
				<div id="features" class="container-fluid text-center features__caption padding-container">
