			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				<div class="navbar white ">
					...
					<div class="menu-item-white">
						...
						<!--white-->
						<div class="js-products navbar__btn navbar__btn__products">
							<img src="<?php echo get_template_directory_uri(); ?>/library/images/btn_products.svg">
							<span>products</span>
						</div>
						
						<a class="navbar__logo" href="<?php echo site_url();?>">
							<img class="logo" src="<?php echo get_template_directory_uri(); ?>/library/images/logo_studioyen.png">
						</a>
					</div>
					<!--black-->
					<div class="menu-item-black">
						...
						<div class="js-products navbar__btn navbar__btn__products">
							<img src="<?php echo get_template_directory_uri(); ?>/library/images/btn_products_black.svg"><span class="black">products</span>
						</div>
						<a class="navbar__logo" href="<?php echo site_url();?>">
